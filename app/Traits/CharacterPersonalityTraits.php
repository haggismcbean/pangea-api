...
class CharacterPersonalityTraits extends Model
{
    ...
    {
        CharacterPersonalityTraits::$enjoysArray = json_decode(file_get_contents("DataStores/Hobbies.json"), true);

        CharacterPersonalityTraits::$believesArray = json_decode(file_get_contents("DataStores/Beliefs.json"), true);
