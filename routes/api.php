...
Route::group(['middleware' => 'auth:api'], function() {
	...
	Route::post('character/point', 'ChatsController@pointAt');
	Route::post('group/messages', 'ChatsController@sendGroupMessage');
});
...
Route::group(['middleware' => 'auth:api'], function() {
	...
	Route::post('zone/share', 'ZoneController@share');
});
